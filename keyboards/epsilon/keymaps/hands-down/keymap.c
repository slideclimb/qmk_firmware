...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [HANDS_DOWN] = LAYOUT_split_3x6_3(
           CW_TOGG,    KC_W,    KC_F,    KC_M,    KC_P,    KC_V,                          KC_SLSH,  KC_DOT,    KC_Q, KC_QUOT,    KC_Z,  KC_EQL,
           KC_SCLN, LFT_GUI, LFT_ALT, LFT_CTL, LFT_SFT,    KC_B,                         KC_COMMA, RGT_SFT, RGT_CTL, RGT_ALT, RGT_GUI,    KC_J,
        TG(QWERTY),    KC_X,    KC_C,    KC_L,    KC_D,    KC_G,                         KC_MINUS,    KC_U,    KC_O,    KC_Y,    KC_K, KC_EXLM,
